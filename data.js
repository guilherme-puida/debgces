...
const issues = [
  ...
  { id: 75, package: "python-static3", authors: [abdul, heitor], status: doing },
  { id: 74, package: "ruby-valid-email", authors: [leonardo], status: doing },
  ...
  { id: 67, package: "python3-colored", authors: [adne, leonardo], status: review },
  { id: 66, package: "python-flask-seeder", authors: [abdul, heitor], status: review },
